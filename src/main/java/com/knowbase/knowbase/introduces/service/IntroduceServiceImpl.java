...
public class IntroduceServiceImpl implements IntroduceService {
    ...
    public ResponseEntity<CustomApiResponse<?>> createIntroduce(IntroduceCreateDto.Req introduceCreateDto) {
        ...
        //응답 dto
        IntroduceCreateDto.CreateIntroduce createdIntroduceResponse = new IntroduceCreateDto.CreateIntroduce(savedIntroduce.getIntroId(),savedIntroduce.getCreateAt());
        //응답
        CustomApiResponse<IntroduceCreateDto.CreateIntroduce> res = CustomApiResponse.createSuccess(HttpStatus.OK.value(), createdIntroduceResponse,"소개글이 작성되었습니다.");
    ...
    public ResponseEntity<CustomApiResponse<?>> updateIntroduce(Long introId, IntroduceUpdateDto.Req introduceUpdateDto) {
        ...
        //응답 dto 생성
        IntroduceUpdateDto.UpdateIntroduce updateIntroduceResponse = IntroduceUpdateDto.UpdateIntroduce.builder()
                .updateAt(introduce.getUpdateAt())
                .build();
        //응답
        CustomApiResponse<IntroduceUpdateDto.UpdateIntroduce> res = CustomApiResponse.createSuccess(HttpStatus.OK.value(), updateIntroduceResponse, "소개글이 수정되었습니다.");
        return ResponseEntity.ok(res);
    }
    ...
    public ResponseEntity<CustomApiResponse<?>> getIntroduce(Long userId) {
        ...
        for(Introduce introduce : findIntroduce){
            introduceResponse.add(IntroduceListDto.IntroduceDto.builder()
                    ...
                    .kakaoId(introduce.getKakaoId())
                    .updatedAt(introduce.getUpdateAt())
                    .build());
        }
